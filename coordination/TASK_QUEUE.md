...
| T-054 | `privacy.html` does not name **Plausible**, which has been loading on 25 of 30 root pages since before the repositioning. A third-party processor runs on every page and the policy does not disclose it. Draft wording is in the D-014 entry; the final wording is an owner-and-lawyer call under gate 9 | L3 | Owner | proposed |
